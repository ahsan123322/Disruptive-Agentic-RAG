...
const Hero = () => {
  return (
    <>
        <section className="OvrHero flex  flex-col  justify-start content-start items-start p-5 sm:p-10">
    <div className='ms-5 sm:ms-10'>
        <div className="flex items-center gap-3   sm:flex-row  sm:items-center text-3xl sm:text-5xl  sm:space-y-0 sm:space-x-3">
            <img src="/assets/Group 72.png" className="w-12 h-12 sm:w-15 sm:h-15" />
        ...
        <div className="  md:items-center text-[#D4EA5E]   px-24 flex  flex-col sm:flex-row  md:px-0 sm:px-5 text-base sm:text-xl space-y-5 sm:space-y-0 sm:space-x-5">
            <div className="descrp flex flex-col  items-center px-3 ">
                <FontAwesomeIcon icon={faServer} size='lg' />
                <p>Custom </p>
                <p>APIs</p>
            </div>
            <div className="descrp flex flex-col space-y-0.5 items-center px-3 text-center">
